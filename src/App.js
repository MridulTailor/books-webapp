      ...
      <BrowserRouter>
        <div>
          <table>
            <tr>
              <td>
                <div style={{ color: "red", fontSize: 20, paddingLeft: 10 }}>
                  This is inline CSS
                </div>
              </td>
              <td>
                <div className="externalStyle">
                  This is External CSS using App.css
                </div>
              </td>
              <td>
                <div
              ...
              <td>
                <div className={appStyle.navbarStyles}>
                  This CSS is applied from AppStyle.module.css
                </div>
              </td>
            </tr>
            <tr>
          ...
          <Link to="/aboutus" style={{ marginLeft: 10 }}>
            AboutUs
          </Link>{" "}
          <br></br>
        </div>
